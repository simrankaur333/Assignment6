...
public class BookStoreLLMTest {
    ...
    void testBookstoreLLMFlow() {
        try (Playwright playwright = Playwright.create()) {
            ...
            page.getByPlaceholder("Please enter your first name").fill("AI");
            page.getByPlaceholder("Please enter your last name").click();
            page.getByPlaceholder("Please enter your last name").fill("Tester");
            page.getByPlaceholder("Please enter a valid email").click();
            page.getByPlaceholder("Please enter a valid email").fill("ai_test@example.com");
            page.getByPlaceholder("Please enter a valid phone").click();
            page.getByPlaceholder("Please enter a valid phone").fill("9876543210");
